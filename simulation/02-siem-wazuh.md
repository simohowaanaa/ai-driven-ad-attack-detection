#  Phase 3 — Wazuh (SIEM/EDR) sur le lab GOAD
 ...
 **Important — NE PAS utiliser `-e wazuh` en ligne de commande** : ce flag **relance TOUTE l'install de base** (ad, adcs, servers…) à chaque fois (long et inutile). On utilise la **console interactive** qui installe **seulement** l'extension.
 ...
 **Phase 4 :** lancer les attaques (Kerberoasting, DCSync, AS-REP…) depuis Kali/outils et **observer les alertes** que Wazuh génère  base pour la Phase 5 (règles de détection) et la Phase 6 (agent IA).
